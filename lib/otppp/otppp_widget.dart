...
import 'otppp_model.dart';
export 'otppp_model.dart';

class OtpppWidget extends StatefulWidget {
  const OtpppWidget({Key? key}) : super(key: key);

  @override
  _OtpppWidgetState createState() => _OtpppWidgetState();
}

class _OtpppWidgetState extends State<OtpppWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtpppModel());
  }
